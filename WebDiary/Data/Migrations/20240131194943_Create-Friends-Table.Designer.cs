...
namespace WebDiary.DAL.Migrations
{
    ...
    [Migration("20240131194943_Create-Friends-Table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebDiary.DAL.Models.Event", b =>
                {
                    ...
                    b.Property<string>("LastBackgroundColor")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebDiary.DAL.Models.Friends", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebDiary.DAL.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UserGroups", b =>
                {
                    b.HasOne("WebDiary.DAL.Models.Group", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebDiary.DAL.Models.Comment", b =>
                {
                    ...
                    b.HasOne("WebDiary.DAL.Models.Comment", "ParentComment")
                        .WithMany()
            ...
            modelBuilder.Entity("WebDiary.DAL.Models.Event", b =>
                {
                    b.HasOne("WebDiary.DAL.Models.User", "DonedBy")
                        .WithMany()
                        .HasForeignKey("DonedById");
            ...
            modelBuilder.Entity("WebDiary.DAL.Models.Friends", b =>
                {
                    b.HasOne("WebDiary.DAL.Models.User", "Friend")
